...
<a class="group no-underline rounded-lg bg-off-white-50 flex flex-col" href="{{ get_field('mediabericht_url') }}" target="_blank">
  <div class="flex flex-col h-[360px] md:h-[320px] xl:h-[280px] px-[16px] py-[16px] group-hocus:bg-purple-700 group-hocus:text-pink transition-colors rounded-lg">
    @php
    ...
    <h2 class="mt-[8px] md:mt-[32px] mb-[8px] md:mb-[12px] text-[1.25rem]/[1.625rem] md:text-[1.375rem]/[1.5rem] xl:text-[1.5rem]/[1.75rem]">{!! get_the_title() !!}</h2>
