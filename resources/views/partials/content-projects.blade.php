...
<a class="group no-underline rounded-lg overflow-hidden bg-off-white-50 flex flex-col" href="{!! the_permalink() !!}">
  ...
  <div class="flex flex-col h-[180px] md:h-[260px] xl:h-[280px] px-[20px] py-[20px] md:pt-[20px] md:px-[28px] md:pb-[28px] xl:pt-[20px] xl:px-[24px] xl:pb-[24px] group-hocus:bg-purple-700 group-hocus:text-pink transition-colors">
