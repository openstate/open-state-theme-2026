{{--
  Template Name: Work With Us - Advice & Strategy Template
--}}
    ...
    <div class="bg-purple-800 text-white px-[16px] md:px-[24px] pt-[88px] md:pt-[120px] pb-[80px] md:pb-[120px]">
      <div class="mx-auto w-full max-w-[1920px] xl:grid xl:grid-cols-12 gap-x-[16px]">
        <header class="xl:col-span-4 mb-[16px] md:mb-[24px] xl:mb-[40px]">
          ...
          <h1 class="font-serif text-[2.25rem]/[2.5rem] tracking-[-0.025rem] md:text-[3.25rem]/[3.5rem] md:tracking-[-0.05rem] xl:text-[4rem]/[4.25rem] xl:tracking-[-0.0625rem] m-0">Advies & strategie</h1>
        </header>
        ...
        <div class="xl:col-span-6 xl:col-start-6">
          ...
          <p class="font-serif mt-[12px] md:mt-[16px] xl:mt-[20px] mb-0 text-[1.125rem]/[1.375rem] md:text-[1.5rem]/[2rem] md:tracking-[-0.00625rem] xl:text-[1.75rem]/[2rem] xl:tracking-[-0.0125rem]">
            Transparantie begint met een plan. Wij helpen overheden een haalbare strategie te ontwikkelen: van nulmeting tot implementatie-roadmap. Onafhankelijk advies zonder commercieel belang.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="px-[16px] md:px-[24px] py-[40px] xl:py-[64px]">
      <div class="mx-auto w-full max-w-[1920px] xl:grid xl:grid-cols-12 xl:gap-x-[16px]">
        ...
        <div class="xl:col-span-8 md:grid md:grid-cols-12 md:gap-x-[16px] gap-y-[48px]">
          <x-work-text title="Geen startpunt">
            De wil om transparanter te worden is er, maar waar begin je? Elke afdeling wijst een andere prioriteit aan.
          </x-work-text>
          <x-work-text title="Wet zonder uitvoering">
            De Woo is er, maar hoe je die praktisch inricht is een ander verhaal. Juridisch klopt het, uitvoerbaar is het niet.
          </x-work-text>
          <x-work-text title="Geen draagvlak">
            Een mooi beleidsstuk verdwijnt in een la als de organisatie niet meebeweegt.
          </x-work-text>
          <x-work-text title="Advies zonder vervolg">
            Er ligt een rapport, maar de eerste concrete stap ontbreekt.
          </x-work-text>
        </div>
      </div>
    </div>
