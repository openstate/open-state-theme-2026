{{--
  Template Name: In The Media Template
--}}
...
@section('content')
  ...
  <div class="px-[16px] md:px-[24px]">
    <div class="mx-auto w-full max-w-[1920px] grid grid-cols-12 gap-y-[16px] mt-[88px] xl:mt-[124px] mb-[64px] md:mb-[84px] xl:mb-[152px]">
      ...
      <div class="col-span-12 md:col-span-6">
        <p class="mb-0 md:text-[1rem]/[1.5rem] xl:text-[1.125rem]/[1.75rem] tracking-[-0.00625rem]">Het werk van Open State Foundation komt regelmatig in de media.<br class="hidden xl:block"> Hier vind je een overzicht.</p>
      </div>
    </div>
    ...
    <div class="mx-auto w-full max-w-[1920px] grid grid-cols-12 gap-[16px] mb-[120px]">
      @while ($the_query->have_posts())
        <? $the_query->the_post() ?>

        <div class="col-span-12 md:col-span-6 xl:col-span-4">
          @include('partials.content-media')
        </div>
      @endwhile
      <? wp_reset_query() ?>
    </div>
