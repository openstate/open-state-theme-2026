...
@section('content')
  @while(have_posts()) @php(the_post())
    <div class="bg-purple-800 text-white xl:grid xl:grid-cols-12 gap-x-[16px] px-[16px] md:px-[24px] pt-[88px] md:pt-[120px] pb-[80px] md:pb-[120px]">
      <div class="xl:col-span-4 mb-[16px] md:mb-[24px] xl:mb-[40px]">
        ...
        <h2 class="font-serif text-[2.25rem]/[2.5rem] tracking-[-0.025rem] md:text-[3.25rem]/[3.5rem] md:tracking-[-0.05rem] xl:text-[4rem]/[4.25rem] xl:tracking-[-0.0625rem] m-0">Samen voor de democratie</h2>
      </div>
    ...
    <div class="xl:grid xl:grid-cols-12 px-[16px] md:px-[24px] py-[40px] xl:py-[64px] xl:gap-x-[16px]">
    ...
    <div class="xl:grid xl:grid-cols-12 px-[16px] md:px-[24px] pt-[40px] pb-[80px] xl:pt-[64px] xl:pb-[100px] xl:gap-x-[16px]">
      <div class="xl:col-span-4">
    ...
    <div class="bg-off-white-50 xl:grid xl:grid-cols-12 px-[16px] md:px-[24px] pt-[40px] md:pt-[80px] xl:pt-[64px] pb-[80px] md:pb-[120px] xl:gap-x-[16px]">
      <div class="xl:col-span-4">
    ...
    <div class="xl:grid xl:grid-cols-12 px-[16px] md:px-[24px] pt-[48px] md:pt-[80px] xl:pt-[64px] pb-[80px] md:pb-[120px] xl:pb-[128px] xl:gap-x-[16px]">
      <div class="xl:col-span-4">
    ...
    <div class="md:grid md:grid-cols-12 bg-cover bg-center bg-no-repeat h-[574px] md:h-[608px] xl:h-[664px] px-[16px] md:px-[24px]" style="background-image: url('{{ Vite::asset('resources/images/pixel_stretch.webp')}}')">
      <div class="md:col-span-8 md:col-start-3 relative z-10 flex flex-col items-center">
        <h2 class="text-center w-[288px] md:w-[480px] mt-[48px] md:mt-[80px] mb-[16px] mb-[40px] xl:mt-[120px] text-[1.75rem]/[2rem] md:text-[2.75rem]/[3rem] xl:text-[3.25rem]/[3.5rem] tracking-[-0.0125rem] md:tracking-[-0.0375rem] xl:tracking-[-0.05rem]">Boek een 30-minuten gesprek</h2>
        <x-button href="/nl/doneren/" text="Boek" />
      </div>
    </div>
  @endwhile
@endsection
