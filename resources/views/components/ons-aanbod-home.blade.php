...
<a href="{{ $href }}" class="flex flex-col snap-start max-[768px]:w-full max-[1280px]:w-[calc(50dvw-64px)] max-[1968px]:w-[calc(25dvw-42px)] min-[1968px]:w-[450px] shrink-0 h-[316px] md:h-[364px] bg-off-white-50 hocus:bg-purple-700 hocus:text-pink transition-colors rounded-lg p-[16px] group">
