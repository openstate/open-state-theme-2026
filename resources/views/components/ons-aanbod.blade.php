...
<x-dynamic-component :component="$variant" title="Tool implementatie" href="/werk-met-ons/tool-implementatie/">
  ...
  <img class="min-h-0 flex-1 w-full object-contain mt-auto mx-auto" src="{{ Vite::asset('resources/images/werk_met_ons_tool_implementatie.svg') }}" alt="">
</x-dynamic-component>
<x-dynamic-component :component="$variant" title="Advies & strategie" href="/werk-met-ons/advies-strategie/">
  ...
  <img class="min-h-0 flex-1 w-full object-contain mt-auto mx-auto" src="{{ Vite::asset('resources/images/werk_met_ons_advies_strategie.svg') }}" alt="">
</x-dynamic-component>
<x-dynamic-component :component="$variant" title="Training & workshops" href="/werk-met-ons/training-workshops/">
  ...
  <img class="min-h-0 flex-1 w-full object-contain mt-auto mx-auto" src="{{ Vite::asset('resources/images/werk_met_ons_training_workshops.svg') }}" alt="">
</x-dynamic-component>
<x-dynamic-component :component="$variant" title="Onderzoek & analyse" href="/werk-met-ons/onderzoek-analyse/">
  ...
  <img class="min-h-0 flex-1 w-full object-contain mt-auto mx-auto" src="{{ Vite::asset('resources/images/werk_met_ons_onderzoek_analyse.svg') }}" alt="">
</x-dynamic-component>
<x-dynamic-component :component="$variant" title="Events & co-creatie" href="/werk-met-ons/events-co-creatie/">
  ...
  <img class="min-h-0 flex-1 w-full object-contain mt-auto mx-auto" src="{{ Vite::asset('resources/images/werk_met_ons_events_co-creatie.svg') }}" alt="">
</x-dynamic-component>
