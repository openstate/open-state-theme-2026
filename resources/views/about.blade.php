...
@section('content')
  @while(have_posts()) @php(the_post())
    <div class="bg-purple-800 text-white md:grid md:grid-cols-12 xl:gap-x-[64px] px-[16px] md:px-[24px] pt-[48px] md:pt-[120px] pb-[80px] md:pb-[200px]">
      <div class="md:col-span-8 col-start-1 xl:col-span-6 mb-[16px] xl:mb-[40px]">
      ...
      <div class="md:col-span-8 col-start-1 xl:col-span-6 xl:h-[520px] flex flex-col">
    ...
    <div class="md:grid md:grid-cols-12 px-[16px] md:px-[24px] py-[40px] md:pt-[64px] xl:py-[64px] xl:gap-x-[16px]">
    ...
    <div class="md:grid md:grid-cols-12 px-[16px] md:px-[24px] py-[40px] md:py-[48px] xl:py-[64px] xl:gap-x-[16px]">
